...
//    val drawableResource = painterResource(id = R.drawable.logo)
    Box(modifier = Modifier
        .fillMaxSize()
        .padding(10.dp), contentAlignment = Alignment.Center ){
        Column(modifier = Modifier
            .padding(10.dp)
            .size(height = 400.dp, width = 1000.dp)
            .background(
...
//            Image(painter = painterResource(id = R.drawable.logo), contentDescription ="" )
            Image(painter = painterResource(id = R.drawable.r), contentDescription = "", modifier = Modifier.width(30.dp).height(30.dp))
                Text(text = "Ulgama giriş",fontSize = 30.sp,fontWeight = FontWeight.Bold,
